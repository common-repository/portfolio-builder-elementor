...
class Swp_Portfolio_Tab extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Tab', 'portfolio-builder-elementor' );
    }
    ...
    // generel settings
     $this->start_controls_section(
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Category Filter', 'portfolio-builder-elementor' ),
            ]
        );
    ...
    $this->start_controls_section(
        'tab_btn_style', [
            'label' => esc_html__( 'Tab Button Style', 'portfolio-builder-elementor' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
...
plugin::instance()->widgets_manager->register_widget_type(new Swp_Portfolio_Tab());