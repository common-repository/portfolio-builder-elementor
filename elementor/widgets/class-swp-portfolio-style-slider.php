...
class Swp_Portfolio_Slider extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Slider', 'portfolio-builder-elementor' );
    }

    public function get_icon() {
        return 'swp-icon eicon-post-list';
    }
        ...
        $this->add_control(
            'style', [
                ...
                'options' => array(
                    ...
                    'style-3'  => esc_html__( 'Style 3', 'portfolio-builder-elementor' ),
                    'style-4'  => esc_html__( 'Style 4', 'portfolio-builder-elementor' ),
                    'style-5'  => esc_html__( 'Style 5', 'portfolio-builder-elementor' ),
                    'style-6'  => esc_html__( 'Style 6', 'portfolio-builder-elementor' ),
                ),
                'default' => 'style-1'
    ...
    $this->start_controls_section(
        'filter_btn_style', [
            'label' => esc_html__( 'Navigation Button Style', 'portfolio-builder-elementor' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
    ...
    $this->add_control(
        ...
        [
            'label' => esc_html__( 'Icon Background Color', 'portfolio-builder-elementor' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
    ...
    $this->add_control(
        ...
        [
            'label' => esc_html__( 'Hover Color', 'portfolio-builder-elementor' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
     ...
     $this->add_control(
        ...
        [
            'label' => esc_html__( 'Hover bg Color', 'portfolio-builder-elementor' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
