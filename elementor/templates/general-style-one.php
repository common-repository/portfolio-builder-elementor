        ...
        <div class="swp-col-lg-6 swp-col-md-6">
            <div class="swp-single-inner style-9">
                ...
                <div class="content-box">
                    ...
                    <?php if( $settings[ 'portfolio-url' ] == 'default' ) : ?>
                        <a class="swp-readmore-btn" href="<?php the_permalink(); ?>"><?php echo esc_html__( 'Read More', 'portfolio-builder-elementor' ); ?> <i class="fas fa-angle-double-right"></i></a>
                    <?php else: ?>
                        <a class="swp-readmore-btn" href="<?php echo esc_url( $swp_meta[0]['url'] ); ?>"><?php echo esc_html__( 'Read More', 'portfolio-builder-elementor' ); ?> <i class="fas fa-angle-double-right"></i></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
